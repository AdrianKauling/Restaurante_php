    ...
    <div class="container">
        ...
        <form action="cadastrar_produto.php" method="POST" id="form_cadastro_produto">
            ...
            <div class="form-group">
                ...
                <input type="text" required class="form-control" id="nome_produto" name="nome_produto" aria-describedby="nomeHelp" placeholder="Digite o produto..">
            </div>
            <br>

            <div class="form-group">
                <label for="categoria_produto">Categoria:</label>
                <input type="text" required class="form-control" id="categoria_produto" name="categoria_produto" aria-describedby="nomeHelp" placeholder="Digite a categoria do produto..">
            </div>
            <br>

            <div class="form-group">
                <label for="valor_produto">Valor unitário (R$): </label>
                <input type="number" required step=".01" class="form-control" id="valor_produto" name="valor_produto" aria-describedby="nomeHelp" placeholder="Digite o valor do produto..">
            </div>
            <br>
            ...
            <div class="form-group">
                ...
                <textarea id="info_produto" class="form-control" name="info_produto" rows="4"></textarea>
            </div>
            <br>
                ...
                <table style="background-color: #236B8E;" class="table">
                    ...
                    <?php foreach ($produtos as $p) : ?>
                        <tr>
                            ...
                            <td><?= $p["data_hora"] ?></td>
                            <td>
                                <a class="btn btn-outline-warning btn-sm" href="produto_form_alterar.php?cod_produto=<?= $p['codigo']; ?>">Alterar</a>
